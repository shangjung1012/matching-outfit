...
class FashionArticle(Base):
    ...
    search_embedding: Mapped[list[float] | None] = mapped_column(Vector(512), nullable=True)
    search_embedding_model: Mapped[str | None] = mapped_column(String(160), nullable=True)
    search_embedding_text: Mapped[str | None] = mapped_column(Text, nullable=True)
